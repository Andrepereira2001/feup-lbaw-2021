...
<section id="services">
  <div class="grid">
    <div class="grid-container">
      <a class="item-amarelo"><img class="img" src={{ asset('img/yellow_project_box.png') }}></a>
      <a class="item-rosa"><img class="img" src={{ asset('img/pink_project_box.png') }}></a>
      <a class="item-azul"><img class="img" src={{ asset('img/blue_project_box.png') }}></a>
      <a class="item-verde"><img class="img" src={{ asset('img/green_project_box.png') }}></a>
